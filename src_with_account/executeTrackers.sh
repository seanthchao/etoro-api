...
do
    ...
    ln -fP /home/sean/etoro/etoro_api/etoro-api/python/drivers/ubuntu/chromedriver /home/sean/etoro/etoro_api/etoro-api/python/drivers/ubuntu/chromedriver_"$i"
    ...
    java_"$i" -jar /home/sean/etoro/etoro-api_no_account/build/libs/etoro-api-0.1.4."$i".jar &
    sleep 10s
done
